...
final class TrazabilidadFotoReferencia
{
    ...
    public static function paraUrl(?string $url): ?string
    {
        ...
        $references = [
            ...
            'tfdKSrICuPC2XuwVtKrm2qcxQlHlUEj4qwbk6oL2.jpg' => 'images/trazabilidad/control-plagas-referencia.jpeg',
            'Gyc7JzFEayHXQKoehhqCFgUPZNQqSmldFcFF3dD7.jpg' => 'images/trazabilidad/fertilizacion-referencia.jpeg',
